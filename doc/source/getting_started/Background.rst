...
Locations f planetary bodies and satellites can be determined in an Earth-centered Earth-Fixed (ECEF) Cartesian coordinate system (*X*, *Y*, and *Z* measurements from the Earth's center of mass).

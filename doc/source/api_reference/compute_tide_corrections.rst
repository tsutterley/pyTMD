...
- Calculates radial solid earth tides (SET) for correcting elevation or imagery data following `IERS Convention (2010) guidelines <http://maia.usno.navy.mil/conventions/2010officialinfo.php>`_

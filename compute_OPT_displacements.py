...
def compute_OPT_displacements(base_dir, input_file, output_file,
	...
	ocean_pole_tide_file = os.path.join(base_dir,'opoleloadcoefcmcor.txt.gz')
...
def main():
	...
	compute_OPT_displacements(base_dir, input_file, output_file, MODE=MODE)

#!/usr/bin/env python
u"""
convert_model_crs.py
Written by Tyler Sutterley (03/2023)
Converts points to and from tide model Coordinates Reference Systems (CRS)

CALLING SEQUENCE:
    x,y = convert_model_crs(lon,lat,PROJ,'F')
    lon,lat = convert_model_crs(x,y,PROJ,'B')
...
def convert_model_crs(
    ...
    try:
        o1, o2 = convert_crs(i1, i2, PROJ, BF, EPSG=EPSG)
